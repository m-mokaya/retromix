...
if __name__ == "__main__":
    ...
    aiz_tb_routes = pd.read_hdf('/vols/opig/users/mokaya/retromix/paper/01_overlook_popular/chemformer/kinases/CHEMBL1075102/CHEMBL1075102_aiz.hdf5', 'table')
    aiz_tf_routes = pd.read_hdf('/vols/opig/users/mokaya/retromix/paper/01_overlook_popular/chemformer/kinases/CHEMBL1075102/CHEMBL1075102_cf2.hdf5', 'table')
