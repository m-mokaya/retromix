...
class Configuration:  # pylint: disable=R0902
    ...
    custom_expansion: str = False # type: ignore
    custom_expansion_policy: str = None
    optimisation_dict: str = None
    optimise_from_dict: bool = False
    allow_foreign_templates: bool = False
    foreign_template_dict: str = None 
